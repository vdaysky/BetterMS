...
public class PlayerList {
    ...
    private static final Class<?> PACKET_PLAYER_INFO_DATA_CLASS = PacketPlayOutPlayerInfo.PlayerInfoData.class;
    private static Class<?> WORLD_GAME_MODE_CLASS;
    protected static final Class<?> GAMEPROFILECLASS = GameProfile.class;
    protected static final Class<?> PROPERTYCLASS = Property.class;
    ...
    // This bit of code has been added to check specifically for 1.7.10.
